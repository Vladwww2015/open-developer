...
class UserFormTest extends TestCase
{
    ...
    {
        $this->visit('developer/users/create')
    ...
    public function testEditForm()
    {
        ...
        $this->visit("developer/users/$id/edit")
    ...
    public function testUpdateFormWithRule()
    {
        ...
        $this->visit("developer/users/$id/edit")
            ->type('', 'email')
            ->press('Submit')
            ->seePageIs("developer/users/$id/edit")
    ...
    public function testFormHeader()
    {
        ...
        $this->visit('developer/users/1/edit')
