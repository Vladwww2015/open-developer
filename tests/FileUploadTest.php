...
class FileUploadTest extends TestCase
{
    ...
    {
        $this->visit('developer/files/create')
            ->see('Files')
...
//            ->seeInElement('a[href="/admin/files"]', 'List')
    ...
    {
        return $this->visit('developer/files/create')
    ...
    public function testUpdateFile()
    {
        ...
        $this->visit('developer/files/1/edit')
            ->see('ID')
            ->see('Created At')
            ->see('Updated At')
            ->seeElement('input[name=file1]')
...
//            ->seeInElement('a[href="/admin/files"]', 'List')
    ...
    public function testDeleteFiles()
    {
        ...
        $this->visit('developer/files')
            ->seeInElement('td', 1);

        $files = FileModel::first()->toArray();

        $this->delete('developer/files/1')
    ...
    public function testBatchDelete()
    {
        ...
        $this->delete('developer/files/1,2,3');
