...
class ImageUploadTest extends TestCase
{
    ...
    {
        return $this->visit('developer/images/create')
    ...
    public function testUpdateImage()
    {
        ...
        $this->visit('developer/images/1/edit')
            ->see('ID')
            ->see('Created At')
            ->see('Updated At')
            ->seeElement('input[name=image1]')
    ...
    public function testDeleteImages()
    {
        ...
        $this->delete('developer/images/1')
    ...
    public function testBatchDelete()
    {
        ...
        $this->delete('developer/images/1,2,3');
    ...
    public function testUploadMultipleImage()
    {
        ...
        $this->visit('developer/multiple-images/create')
        ...
        $this->call(
            'POST', // $method
            '/developer/multiple-images', // $action
            [], // $parameters
            [],
            $files
        );
        ...
        $this->assertRedirectedTo('/developer/multiple-images');
