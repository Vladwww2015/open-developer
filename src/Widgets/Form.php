...
namespace OpenDeveloper\Developer\Widgets;
...
use OpenDeveloper\Developer\Form as BaseForm;
...
class Form implements Renderable
{
    ...
    protected function addConfirmScript()
    {
        ...
        $trans = [
            'cancel' => trans('developer.cancel'),
            'submit' => trans('developer.submit'),
        ];
        ...
        var confirmSubmit = function(e) {
            ...
            Swal.fire($settings).then(function (result) {
                if (result.value == true) {
                    if (developer.form.validate(form)){
...
JS;
    ...
    protected function addCascadeScript()
    {
        ...
        $script = <<<SCRIPT
        developer.form.disable_cascaded_forms("form#{$id}");
SCRIPT;
    ...
    protected function prepareHandle()
    {
        if (method_exists($this, 'handle')) {
            $this->method('POST');
            $this->action(developer_url('_handle_form_'));
    ...
    public function render()
    {
        ...
        $form = view('developer::widgets.form', $this->getVariables())->render();
