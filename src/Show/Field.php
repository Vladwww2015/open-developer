...
use OpenDeveloper\Developer\Widgets\Carousel;
...
class Field implements Renderable
{
     ...
     * @var string
     */
    protected $view = 'developer::show.field';
    ...
    public function file($server = '', $download = true)
    {
        ...
        return $this->unescape()->as(function ($path) use ($server, $download, $field) {
            ...
            if (url()->isValidUrl($path)) {
                ...
                $storage = Storage::disk(config('developer.upload.disk'));
...
HTML;
    ...
    protected function callExtendedField($abstract, $arguments = [])
    {
        ...
        if (!isset($extend)) {
            developer_warning("[$abstract] is not a valid Show field.");
