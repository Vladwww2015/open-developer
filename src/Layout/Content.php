...
class Content implements Renderable
{
    ...
    {
        return $this->body(Developer::component($view, $data));
    }
    ...
    {
        return $this->row(developer_dump(...func_get_args()));
    }
    ...
    {
        developer_success($title, $message);
    ...
    {
        developer_warning($title, $message);
    ...
    public function render()
    {
        ...
        return view('developer::content', $items)->render();
    }
}
