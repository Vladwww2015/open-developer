...
class Dashboard
{
    ...
    {
        return view('developer::dashboard.title');
    }
    ...
    public static function extensions()
    {
        ...
        foreach ($extensions as &$extension) {
            ...
            $extension['installed'] = array_key_exists(end($name), Developer::$extensions);
        }

        return view('developer::dashboard.extensions', compact('extensions'));
    }
