...
use OpenDeveloper\Developer\Show\Divider;
use OpenDeveloper\Developer\Show\Field;
use OpenDeveloper\Developer\Show\Panel;
use OpenDeveloper\Developer\Show\Relation;
...
class Show implements Renderable
{
    ...
    public function render()
    {
        ...
        return view('developer::show', $data)->render();
    }
}
