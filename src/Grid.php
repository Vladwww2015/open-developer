...
use OpenDeveloper\Developer\Grid\Column;
use OpenDeveloper\Developer\Grid\Concerns;
use OpenDeveloper\Developer\Grid\Displayers;
use OpenDeveloper\Developer\Grid\Model;
use OpenDeveloper\Developer\Grid\Row;
use OpenDeveloper\Developer\Grid\Tools;
...
class Grid
{
     ...
     *
     * @var \OpenDeveloper\Developer\Grid\Model|\Illuminate\Database\Eloquent\Builder
     */
    protected $model;
     ...
     * @var string
     */
    protected $view = 'developer::grid.table';
    ...
    protected function addRelationColumn($name, $label = '')
    {
        ...
        if (!method_exists($model, $relation) || !$model->{$relation}() instanceof Relations\Relation) {
            ...
            developer_error("Call to undefined relationship [{$relation}] on model [{$class}].");
    ...
    protected function prependRowSelectorColumn()
    {
        ...
        $checkAllBox = '<input type="checkbox" class="'.$this->getSelectAllName().' form-check-input" onchange="developer.grid.select_all(event,this)" id="grid-select-all" />&nbsp;';
    ...
    public function render()
    {
        ...
        return Developer::component($this->view, $this->variables());
    }
}
