...
class Paginator extends AbstractTool
{
    ...
    {
        return $this->paginator->render('developer::pagination');
    }
    ...
    protected function paginationRanger()
    {
        ...
        return trans('developer.pagination.range', $parameters->all());
    }
    ...
    public function render()
    {
        ...
        return view('developer::grid.pagination', $vars)->render();
    }
}
