...
namespace OpenDeveloper\Developer\Grid\Displayers\Actions;

use OpenDeveloper\Developer\Actions\RowAction;
use OpenDeveloper\Developer\Developer;
use OpenDeveloper\Developer\Grid\Actions\Delete;
use OpenDeveloper\Developer\Grid\Actions\Edit;
use OpenDeveloper\Developer\Grid\Actions\Show;
use OpenDeveloper\Developer\Grid\Displayers\AbstractDisplayer;

class Actions extends AbstractDisplayer
{
    protected $view = 'developer::grid.actions.actions';
    ...
    public function display($callback = null)
    {
        ...
        return Developer::component($this->view, $variables);
    }
}
