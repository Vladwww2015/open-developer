...
namespace OpenDeveloper\Developer\Form;
...
use OpenDeveloper\Developer\Widgets\Form as WidgetForm;
...
class NestedForm
{
    ...
    /**
     * @var \OpenDeveloper\Developer\Form|\OpenDeveloper\Developer\Widgets\Form
     */
    protected $form;
    ...
    protected function prepareRecord($record)
    {
        ...
        foreach ($this->fields as $field) {
            ...
            if (($field instanceof \OpenDeveloper\Developer\Form\Field\Hidden) || $value != $field->original() || ($this->save_null_values && $value == null)) {
                if (is_array($columns)) {
    ...
    public function getTemplateHtmlAndScript()
    {
        ...
        /* @var Field $field */
        foreach ($this->fields() as $field) {
            //when field render, will push $script to Developer
            $html .= $field->render();

            /*
             * Get and remove the last script of Developer::$script stack.
             */
            if ($field->getScript()) {
                $scripts[] = array_pop(Developer::$script);
            }
        }
