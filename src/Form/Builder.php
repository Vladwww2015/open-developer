...
use OpenDeveloper\Developer\Form\Field\Hidden;
...
class Builder
{
    ...
    public function title(): string
    {
        ...
        if ($this->mode === static::MODE_CREATE) {
            return trans('developer.create');
        }

        if ($this->mode === static::MODE_EDIT) {
            return trans('developer.edit');
        }
    ...
    {
        $trans = [
            'confirm' => trans('developer.confirm'),
...
JS;
    ...
    {
        $script = <<<JS
        developer.form.disable_cascaded_forms("form.{$this->formClass}");
JS;
