...
class Listbox extends MultipleSelect
{
    ...
    protected static $css = [
        '/vendor/open-developer/dual-listbox/dual-listbox.css',
        // overwritten bootstrap styles
    ];
    */

    protected static $js = [
        '/vendor/open-developer/dual-listbox/dual-listbox-custom.js',
    ];
    ...
    public function render()
    {
        ...
        $settings = array_merge([
            'availableTitle'        => trans('developer.listbox.title_available'),
            'selectedTitle'         => trans('developer.listbox.title_selected'),
            'minHeight'             => 200,
        ], $this->settings);
