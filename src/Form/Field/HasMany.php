...
use OpenDeveloper\Developer\Form\Field\Traits\Sortable;
use OpenDeveloper\Developer\Form\NestedForm;
...
class HasMany extends Field
{
     ...
     */
    protected $views = [
        'default' => 'developer::form.hasmany',
        'tab'     => 'developer::form.hasmanytab',
        'table'   => 'developer::form.hasmanytable',
    ];
