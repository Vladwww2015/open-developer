...
class Map extends Field
{
    ...
    {
        switch (config('developer.map_provider')) {
            case 'tencent':
                $css = '';
            ...
            case 'openstreetmaps':
            default:
                $css = ['/vendor/open-developer/leaflet/leaflet.css', '/vendor/open-developer/leaflet/leaflet-geosearch.css'];
                $js = ['/vendor/open-developer/leaflet/leaflet.js', '/vendor/open-developer/leaflet/leaflet-geosearch.js'];
        }
