...
use OpenDeveloper\Developer\Form\Field\Traits\HasMediaPicker;
use OpenDeveloper\Developer\Form\Field\Traits\UploadField;
...
class File extends Field
{
    ...
    protected static $css = [
        '/vendor/open-developer/fields/file-upload/file-upload.css',
    ];

    protected static $js = [
        '/vendor/open-developer/fields/file-upload/file-upload.js',
    ];
    ...
    {
        return config('developer.upload.directory.file');
    }
    ...
    public function render()
    {
        ...
        $this->options(['overwriteInitial' => true, 'msgPlaceholder' => trans('developer.choose_file')]);
