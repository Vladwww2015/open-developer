...
use OpenDeveloper\Developer\Form\Field\Traits\CanCascadeFields;
    ...
    public function load($field, $url, $idField = 'id', $textField = 'text', bool $allowClear = true)
    {
        ...
        $this->additional_script .= <<<JS
            ...
            elm.addEventListener('change', function(event) {
                ...
                developer.ajax.post("{$url}",{query:query},function(data){
                    let found = false;
                    for (i in data.data){
...
JS;
    ...
    protected function loadRemoteOptions($url, $parameters = [], $options = [])
    {
        ...
        $this->additional_script .= <<<JS
        developer.ajax.post("{$url}",{$parameters_json},function(data){
...
JS;
    ...
    public function allowedChoicesJs()
    {
        ...
        return in_array($class, [
            'OpenDeveloper\Developer\Form\Field\Select',
            'OpenDeveloper\Developer\Form\Field\Tags',
            'OpenDeveloper\Developer\Form\Field\MultipleSelect',
            'OpenDeveloper\Developer\Form\Field\Timezone',
        ]);
    }
