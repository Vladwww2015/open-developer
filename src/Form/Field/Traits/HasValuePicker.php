...
use OpenDeveloper\Developer\Form\Field\ValuePicker;
...
trait HasValuePicker
{
    ...
    {
        $this->mountPicker()
            ->setView('developer::form.filepicker')
            ->attribute('type', 'text')
        ...
        return Developer::component('developer::form.filepicker', $this->variables());
    }
}
