...
class Field implements Renderable
{
    ...
    {
        return $this->placeholder ?: trans('developer.input').' '.$this->label;
    }
    ...
    public function getView(): string
    {
        ...
        return 'developer::form.'.strtolower(end($class));
    }
     ...
     *
     * @return \OpenDeveloper\Developer\Form\Field
     */
    ...
    public function render()
    {
        ...
        return Developer::component($this->getView(), $vars);
    }
