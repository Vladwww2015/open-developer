...
class FormCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'developer:form {name}
        {--title=}
        {--step}
        {--namespace=}';
     ...
     * @var string
     */
    protected $description = 'Make developer form widget';
    ...
    protected function getDefaultNamespace($rootNamespace)
    {
        ...
        return str_replace('Controllers', 'Forms', config('developer.route.namespace'));
    }
