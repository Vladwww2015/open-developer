...
class ExtendCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'developer:extend {extension} {--namespace=}';
     ...
     * @var string
     */
    protected $description = 'Build a Open-developer extension';
    ...
    public function handle(Filesystem $filesystem)
    {
        ...
        $this->extensionDir = config('developer.extension_dir');
