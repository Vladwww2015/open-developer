...
class MakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'developer:make {model}
        {--title=}
        {--name=}
     ...
     * @var string
     */
    protected $description = 'Make developer controller';
    ...
    public function handle()
    {
        ...
        if (!$this->modelExists()) {
            $this->error('Model does not found! use, command like: artisan developer:controller \\\\App\\\\Models\\\\ModelName');
        ...
        if (parent::handle() !== false) {
            ...
            $this->line('');
            $this->comment('Add the following route to app/Developer/routes.php:');
            $this->line('');
    ...
    {
        $this->alert("open-developer controller code for model [{$modelName}]");
    ...
    protected function getDefaultNamespace($rootNamespace)
    {
        ...
        return config('developer.route.namespace');
    }
