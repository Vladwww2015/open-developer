        ...
        <div class="modal-content">
            ...
            <form class="form form-horizontal" method="{{$method}}" action="{{$url}}" autocomplete="off" @if(!empty($multipart))enctype="multipart/form-data"@endif>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">{{ __('developer.close') }}</button>
                    <button type="submit" class="btn btn-primary">{{ __('developer.submit') }}</button>
                </div>
            </form>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
