    ...
    developer.grid.inline_edit = {
        ...
        init : function(){
            ...
            document.addEventListener('click', function (event) {
                if (developer.grid.inline_edit.popover){
                    developer.grid.inline_edit.popover.hide();
                }
            });
        },
        ...
        hide_ohter_popovers : function(me){
            ...
            developer.grid.inline_edit.popovers.forEach(popover =>{
        ...
        init_popover : function(triggerId,target){
            ...
            var popover = new bootstrap.Popover(el, {
                ...
                content : function () {
                    ...
                    if(typeof(developer.grid.inline_edit.functions[triggerId]) != 'undefined'){
                        if(typeof(developer.grid.inline_edit.functions[triggerId].content) === "function"){
                            developer.grid.inline_edit.functions[triggerId].content(el,content.content);
                        }
                    }
            ...
            el.addEventListener('show.bs.popover', function (event) {
                ...
                developer.grid.inline_edit.trigger = this;
                developer.grid.inline_edit.popover = popover;
                developer.grid.inline_edit.hide_ohter_popovers(popover)
                ...
                if (typeof(popover.eventsAdded) == 'undefined'){
                    popover.tip.addEventListener("click",function(event){
                        ...
                        if (event.target.classList.contains("ie-submit")){
                            developer.grid.inline_edit.save();
                        }
            ...
            el.addEventListener('shown.bs.popover', function (event) {
                ...
                triggerId = this.id;
                if(typeof(developer.grid.inline_edit.functions[triggerId]) != 'undefined'){
                    if(typeof(developer.grid.inline_edit.functions[triggerId].shown) === "function"){
                        developer.grid.inline_edit.functions[triggerId].shown(el,popover.tip);
                    }
                }
            })
            ...
            developer.grid.inline_edit.popovers.push(popover);

        },

        save : function(){

            let popover = developer.grid.inline_edit.popover;
            let content = popover.tip.querySelector(".ie-container");
        ...
        retrieveValues : function(trigger,content){
            ...
            if(typeof(developer.grid.inline_edit.functions[triggerId]) != 'undefined'){
                if(typeof(developer.grid.inline_edit.functions[triggerId].returnValue) === "function"){
                    val = developer.grid.inline_edit.functions[triggerId].returnValue(trigger,content);
                }
            }
            console.log(val);
            if (!val){
