...
/*-------------------------------------------------*/
    ...
    developer.resource = {
        ...
        delete_do : function(resource_url,navigate_url){
                ...
                preConfirm: function() {
                    return new Promise(function(resolve) {
                        ...
                        developer.ajax.post(url,data,function(data){
                            resolve(data);
                            if (navigate_url){
                                developer.ajax.navigate(navigate_url);
                            }else{
            ...
            }).then(developer.resource.default_swal_response);
        },
        ...
        batch_edit : function (resource_url){
            ...
            developer.ajax.navigate(edit_url);
        },
        ...
        default_swal_response_and_reload : function(result) {
            developer.ajax.reload();
            developer.resource.default_swal_response(result);
        }
    }
