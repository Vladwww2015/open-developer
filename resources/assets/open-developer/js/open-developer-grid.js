...
/*-------------------------------------------------*/
    ...
    developer.grid = {
        ...
        check_status : function(){
            ...
            document.querySelectorAll(".grid-row-checkbox").forEach( box => {
                ...
                if (!box.checked){
                    ...
                    if (!developer.grid.selected.includes(box.dataset.id)){
                        developer.grid.selected.push(box.dataset.id);
                        num_selected ++;
                    }
                }
            })
        ...
        export_selected_row : function(event){
            ...
            let rows = developer.grid.selected.join();
            if (rows == ""){
                Swal.fire({
                    icon: 'info',
        ...
        columns : {
            ...
            submit : function(){
                ...
                developer.ajax.navigate(url.toString());
        ...
        hotkeys : function() {
            ...
            document.removeEventListener("keydown", developer.grid.hotkeys_handle,false);
            document.addEventListener("keydown", developer.grid.hotkeys_handle,false);
        },
        ...
        hotkeys_handle : function (e){
            ...
            switch(e.which) {
                ...
                case 82: // `r` for reload
                    ...
                    developer.toastr.success(__('refresh_succeeded'), {positionClass:"toast-top-center"});
                    break;
                ...
                case 46: // `delete` batch delete
                    if (developer.grid.selected.length){
